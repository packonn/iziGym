  ...
  return (
    ...
    <div class="flex h-[calc(100vh-80px)] items-center justify-center p-5 w-full bg-white">
      ...
      <Title
					...
					color="secondary"
				/>
        <div class="inline-flex rounded-full bg-[#d39167] p-4">
          <div class="rounded-full stroke-secondary bg-primary p-4">
        ...
        <h1 class="mt-5 text-[36px] font-bold text-slate-800 lg:text-[50px]">Merci de patienter, le site est en maintenance</h1>
      </div>
    </div>
    </>
  )
